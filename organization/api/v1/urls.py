...
urlpatterns = [
    ...
    path("invite/<uuid:token>/validate/", RegisterFromInviteAPIView.as_view(), name="validate-invite"),
    path("student-management-system/join/<uuid:token>/", RetrieveInviteLinkAPIView.as_view(), name="register-invite"),
